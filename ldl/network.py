...
########### Make sure all funs are added by default. Try to shorten the
# names in the class
    def __init__(self, weights, biases):
        ...
        self.backpropagate_errors = backpropagate_errors
        ...
        self.weight_partial_derivative_fun = get_weight_partial_derivatives_vec
    ...
    def run_one_epoch(self, data, weights, biases, targets, learning_rate):
        ...
        output_error = self.output_error_vec(
        ...
        errors = self.backpropagate_errors(weights=weights[1:],
